...
# print(height,weigth)
last_mes = current_mes = np.array((0, height // 2), np.float32)
last_pre = current_pre = np.array((0, height // 2), np.float32)
...
def mousemove(event, x, y, s, p):
    ...
    cv2.line(frame, (int(lmx), int(lmy)), (int(cmx), int(cmy)), (0, 200, 0))
